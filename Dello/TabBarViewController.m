...
;
    ...
    //Third Tab Bar
    UIStoryboard *voteStoryboard = [UIStoryboard storyboardWithName:@"Vote" bundle:nil];
    UITabBarController *voteTabBar = [voteStoryboard instantiateViewControllerWithIdentifier:@"VoteNavController"];
    [self addChildViewController:voteTabBar];
    voteTabBar.tabBarItem.image = [self imageWithImage:[UIImage imageNamed:@"voteTab.png"] scaledToSize:CGSizeMake(35, 35)];
    voteTabBar.tabBarItem.title = @"Vote";
    voteTabBar.tabBarItem.enabled = NO;
